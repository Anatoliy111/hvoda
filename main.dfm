object MainForm: TMainForm
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          object cxGrid3DBTableView1KUB_ALL: TcxGridDBColumn
            ...
            DataBinding.FieldName = 'KUB_ALL'
            Options.Editing = False
            Styles.OnGetContentStyle = cxGrid3DBTableView1KUB_ALLStylesGetContentStyle
            Width = 75
          end
          ...
          object cxGrid3DBTableView1SCH_RAZNDOM: TcxGridDBColumn
            ...
            Options.Editing = False
            Styles.OnGetContentStyle = cxGrid3DBTableView1SCH_RAZNDOMStylesGetContentStyle
          end
        end
  ...
  object ImageList1: TImageList
    ...
    Top = 156
    Bitmap = {
      494C01013E004000080214001400FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object hvddom2: TIBDataSet
    ...
    SelectSQL.Strings = (
      ...
      'order by ul,n_dom) hv'
        ...
        'vgrp.yearmon=:yearmon and hvgrp.yearmon=hvgrp.yearmonp')
    ModifySQL.Strings = (
      'update h_voda'
      'set'
      '  DATE_POK = :DATE_POK,'
  ...
  object hv_per: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into hv_per'
        ...
        '  (DATE_POK, DEL_NORM, FIO, GRP_RAZN, KL, KL_UL, KOLI_P, KUB_ALL' +
        ', KUB_NOBALANS, '
      
        '   KV, N_DOM, NOR_RAZN, NORM_BLICH, NOTE, NOTEWID, ORG, PERE_RAZ' +
        'N, PERERAH, '
      '   POD, SCH_RAZN, SCHET, UL, WID, WID_PREV, YEARMON, YEARMONP)'
      'values'
      
        '  (:DATE_POK, :DEL_NORM, :FIO, :GRP_RAZN, :KL, :KL_UL, :KOLI_P, ' +
        ':KUB_ALL, '
      
        '   :KUB_NOBALANS, :KV, :N_DOM, :NOR_RAZN, :NORM_BLICH, :NOTE, :N' +
        'OTEWID, '
      
        '   :ORG, :PERE_RAZN, :PERERAH, :POD, :SCH_RAZN, :SCHET, :UL, :WI' +
        'D, :WID_PREV, '
      '   :YEARMON, :YEARMONP)')
    RefreshSQL.Strings = (
      'Select '
    ...
    SelectSQL.Strings = (
        ...
        'select * from hv_per where yearmon in (select first 12 yearmon f' +
    ...
    Left = 640
    Top = 352
    object hv_perKL: TIntegerField
      FieldName = 'KL'
      Origin = '"HV_PER"."KL"'
      Required = True
    end
    object hv_perYEARMON: TIntegerField
      FieldName = 'YEARMON'
      Origin = '"HV_PER"."YEARMON"'
    end
    object hv_perYEARMONP: TIntegerField
      FieldName = 'YEARMONP'
      Origin = '"HV_PER"."YEARMONP"'
    end
    object hv_perFIO: TIBStringField
      FieldName = 'FIO'
      Origin = '"HV_PER"."FIO"'
      Size = 35
    end
    object hv_perWID: TSmallintField
      FieldName = 'WID'
      Origin = '"HV_PER"."WID"'
    end
    object hv_perWID_PREV: TIntegerField
      FieldName = 'WID_PREV'
      Origin = '"HV_PER"."WID_PREV"'
    end
    object hv_perSCHET: TIBStringField
      FieldName = 'SCHET'
      Origin = '"HV_PER"."SCHET"'
      Required = True
      Size = 10
    end
    object hv_perSCH_RAZN: TIBBCDField
      FieldName = 'SCH_RAZN'
      Origin = '"HV_PER"."SCH_RAZN"'
      Precision = 18
      Size = 4
    end
    object hv_perKOLI_P: TIBBCDField
      FieldName = 'KOLI_P'
      Origin = '"HV_PER"."KOLI_P"'
      Precision = 18
      Size = 4
    end
    object hv_perNOR_RAZN: TIBBCDField
      FieldName = 'NOR_RAZN'
      Origin = '"HV_PER"."NOR_RAZN"'
      Precision = 18
      Size = 4
    end
    object hv_perGRP_RAZN: TIBBCDField
      FieldName = 'GRP_RAZN'
      Origin = '"HV_PER"."GRP_RAZN"'
      Precision = 18
      Size = 4
    end
    object hv_perPERE_RAZN: TIBBCDField
      FieldName = 'PERE_RAZN'
      Origin = '"HV_PER"."PERE_RAZN"'
      Precision = 18
      Size = 4
    end
    object hv_perUL: TIBStringField
      FieldName = 'UL'
      Origin = '"HV_PER"."UL"'
      Size = 70
    end
    object hv_perN_DOM: TIBStringField
      FieldName = 'N_DOM'
      Origin = '"HV_PER"."N_DOM"'
      Size = 10
    end
    object hv_perKV: TIBStringField
      FieldName = 'KV'
      Origin = '"HV_PER"."KV"'
      Size = 10
    end
    object hv_perPOD: TIntegerField
      FieldName = 'POD'
      Origin = '"HV_PER"."POD"'
    end
    object hv_perDATE_POK: TDateField
      FieldName = 'DATE_POK'
      Origin = '"HV_PER"."DATE_POK"'
    end
    object hv_perORG: TIntegerField
      FieldName = 'ORG'
      Origin = '"HV_PER"."ORG"'
    end
    object hv_perDEL_NORM: TFloatField
      FieldName = 'DEL_NORM'
      Origin = '"HV_PER"."DEL_NORM"'
    end
    object hv_perKL_UL: TIntegerField
      FieldName = 'KL_UL'
      Origin = '"HV_PER"."KL_UL"'
    end
    object hv_perNORM_BLICH: TFloatField
      FieldName = 'NORM_BLICH'
      Origin = '"HV_PER"."NORM_BLICH"'
    end
    object hv_perKUB_NOBALANS: TFloatField
      FieldName = 'KUB_NOBALANS'
      Origin = '"HV_PER"."KUB_NOBALANS"'
    end
    object hv_perKUB_ALL: TFloatField
      FieldName = 'KUB_ALL'
      Origin = '"HV_PER"."KUB_ALL"'
    end
    object hv_perPERERAH: TFloatField
      FieldName = 'PERERAH'
      Origin = '"HV_PER"."PERERAH"'
    end
    object hv_perNOTEWID: TIBStringField
      FieldName = 'NOTEWID'
      Origin = '"HV_PER"."NOTEWID"'
      Size = 100
    end
    object hv_perNOTE: TIBStringField
      FieldName = 'NOTE'
      Origin = '"HV_PER"."NOTE"'
      Size = 100
    end
  ...
  object grpall: TIBDataSet
    ...
    SelectSQL.Strings = (
        ...
        'select * from HVGRP where yearmon in (select first 12 yearmon fr' +
        'om data order by yearmon desc) order by yearmon')
    ModifySQL.Strings = (
      'update HVGRP'
      'set'
      '  DOM = :DOM,'
    ...
    Left = 680
    Top = 352
    object grpallKL: TIntegerField
      FieldName = 'KL'
      Origin = '"HVGRP"."KL"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object grpallYEARMON: TIntegerField
      FieldName = 'YEARMON'
      Origin = '"HVGRP"."YEARMON"'
      Required = True
    end
    object grpallSCH0: TIBStringField
      FieldName = 'SCH0'
      Origin = '"HVGRP"."SCH0"'
      Size = 10
    end
    object grpallSCH1: TIBStringField
      FieldName = 'SCH1'
      Origin = '"HVGRP"."SCH1"'
      Size = 10
    end
    object grpallRAZN: TFloatField
      FieldName = 'RAZN'
      Origin = '"HVGRP"."RAZN"'
    end
    object grpallNORMA: TFloatField
      FieldName = 'NORMA'
      Origin = '"HVGRP"."NORMA"'
    end
    object grpallNOTE: TIBStringField
      FieldName = 'NOTE'
      Origin = '"HVGRP"."NOTE"'
      Size = 45
    end
    object grpallDOM: TIBStringField
      FieldName = 'DOM'
      Origin = '"HVGRP"."DOM"'
      Size = 5
    end
    object grpallPOD: TIntegerField
      FieldName = 'POD'
      Origin = '"HVGRP"."POD"'
    end
    object grpallSCH_OLD: TFloatField
      FieldName = 'SCH_OLD'
      Origin = '"HVGRP"."SCH_OLD"'
    end
    object grpallSCH_CUR: TFloatField
      FieldName = 'SCH_CUR'
      Origin = '"HVGRP"."SCH_CUR"'
    end
    object grpallSCH_RAZN: TFloatField
      FieldName = 'SCH_RAZN'
      Origin = '"HVGRP"."SCH_RAZN"'
    end
    object grpallNORMA_BL: TFloatField
      FieldName = 'NORMA_BL'
      Origin = '"HVGRP"."NORMA_BL"'
    end
    object grpallN_LICH: TIBStringField
      FieldName = 'N_LICH'
      Origin = '"HVGRP"."N_LICH"'
    end
    object grpallTIP: TIBStringField
      FieldName = 'TIP'
      Origin = '"HVGRP"."TIP"'
    end
    object grpallKL_UL: TIntegerField
      FieldName = 'KL_UL'
      Origin = '"HVGRP"."KL_UL"'
    end
    object grpallUL: TIBStringField
      FieldName = 'UL'
      Origin = '"HVGRP"."UL"'
      Size = 70
    end
    object grpallN_DOM: TIBStringField
      FieldName = 'N_DOM'
      Origin = '"HVGRP"."N_DOM"'
      Size = 10
    end
    object grpallSCH_NAS: TFloatField
      FieldName = 'SCH_NAS'
      Origin = '"HVGRP"."SCH_NAS"'
    end
    object grpallSCH_UR: TFloatField
      FieldName = 'SCH_UR'
      Origin = '"HVGRP"."SCH_UR"'
    end
    object grpallSCH_SUMABON: TFloatField
      FieldName = 'SCH_SUMABON'
      Origin = '"HVGRP"."SCH_SUMABON"'
    end
    object grpallSCH_KUB: TFloatField
      FieldName = 'SCH_KUB'
      Origin = '"HVGRP"."SCH_KUB"'
    end
  end
