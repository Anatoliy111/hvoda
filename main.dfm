object MainForm: TMainForm
      ...
      object cxGrid2: TcxGrid
        ...
        object DBGrid1: TcxGridDBBandedTableView
          ...
          object DBGrid1NOR_RAZN: TcxGridDBBandedColumn
            ...
            Properties.OnValidate = DBGrid1NOR_RAZNPropertiesValidate
            Width = 80
    ...
    object cxTabSheet4: TcxTabSheet
      ...
      object cxGrid1: TcxGrid
        ...
        object cxGridDBBandedTableView1: TcxGridDBBandedTableView
          ...
          object cxGridDBBandedTableView1SPIS: TcxGridDBBandedColumn
            Caption = #1057#1087#1080#1089#1072#1085#1085#1103
            DataBinding.FieldName = 'SPIS'
            Width = 74
            Position.BandIndex = 2
  ...
  object hvdall: TIBDataSet
    ...
    object hvdallWID_PREV: TIntegerField
      FieldName = 'WID_PREV'
      Origin = '"H_VODA"."WID_PREV"'
    end
    object hvdallSPIS: TFloatField
      FieldName = 'SPIS'
      Origin = '"H_VODA"."SPIS"'
    end
  end
  ...
  object org: TIBDataSet
    ...
    object orgWID_PREV: TIntegerField
      FieldName = 'WID_PREV'
      Origin = '"H_VODA"."WID_PREV"'
    end
    object orgSPIS: TFloatField
      FieldName = 'SPIS'
      Origin = '"H_VODA"."SPIS"'
    end
  end
  ...
  object imp: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into IMPEXP'
        ...
        '  (EDRPOU, IMPALLOW, IMPLASTDATE, IMPLASTDAY, KL, LASTEXP, LASTR' +
        'OZR, VPROG)'
      'values'
      
        '  (:EDRPOU, :IMPALLOW, :IMPLASTDATE, :IMPLASTDAY, :KL, :LASTEXP,' +
        ' :LASTROZR, '
      '   :VPROG)')
    RefreshSQL.Strings = (
      'Select '
    ...
    object impEDRPOU: TIntegerField
      FieldName = 'EDRPOU'
      Origin = '"IMPEXP"."EDRPOU"'
    end
  end
  ...
  object hvddom2: TIBDataSet
    ...
    object hvddom2YEARMON: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'YEARMON'
    ...
    object hvddom2SPIS: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'SPIS'
      Origin = '"HVDOM"."SPIS"'
      ProviderFlags = []
  ...
  object spis: TIBDataSet
    Database = IBDatabase
    Transaction = IBTransaction1
    AfterEdit = spisAfterEdit
    AfterInsert = spisAfterInsert
    DeleteSQL.Strings = (
      'delete from SPIS'
      'where'
      '  ID = :OLD_ID')
