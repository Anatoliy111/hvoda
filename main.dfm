object MainForm: TMainForm
  ...
  object ImageList1: TImageList
    ...
    Top = 156
    Bitmap = {
      494C01013E004000100214001400FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object hvdrozpdom: TIBDataSet
    ...
    RefreshSQL.Strings = (
      ...
      '  KL = :KL')
    SelectSQL.Strings = (
      'select * from HV_PER where yearmon=:yearmon and yearmon=yearmonp')
    ModifySQL.Strings = (
      'update HV_PER'
      'set'
      '  DATE_POK = :DATE_POK,'
    ...
    object hvdrozpdomYEARMONP: TIntegerField
      FieldName = 'YEARMONP'
    ...
    object hvdrozpdomNOTEWID: TIBStringField
      FieldName = 'NOTEWID'
  ...
  object hv_perSource: TDataSource
    DataSet = hv_per
    Left = 640
    Top = 384
  end
